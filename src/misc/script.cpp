...
static struct BlacklistEntry BlacklistedPrefixes[] = {
	 ...
	 {0x283A4302, 0x283A4302, "SPD6"},
	 {0x99015DDA, 0x99015DDA, "SPD7"},
   {0x72152D70, 0x72152D70, "SPD8"},
   {0xEB3A5929, 0xEB3A5929, "SPD9"},
   {0x0D19320B, 0x0D19320B, "SPD10"},
   {0xAE525317, 0xAE525317, "SPD11"},
   {0xB28A6512, 0xB28A6512, "SPD12"},
   {0xA7E71056, 0xA7E71056, "SPD13"},
   {0x7B88CD19, 0x7B88CD19, "SPD14"},
   {0x8422ED1C, 0x8422ED1C, "SPD15"}
