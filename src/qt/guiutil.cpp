...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("stipend://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "stipend:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Stipend-Qt") + " " + tr("version") + " " +
